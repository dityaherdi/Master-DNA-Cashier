...
class RekapLabaController extends HomeController
{
    ...
    public function preview(Request $request) {
            ...
            if (!isset($input['_token'])) {
		        ...
		        if ($start == '' || $end == '') {
                    if ($jenis == null || trim($jenis) == '') {
                        $penjualan = DB::table('penjualan_detail')
                            ...
                            ->select(DB::raw('SUM(penjualan_detail.harga_jual * penjualan_detail.jumlah) as total, SUM(penjualan_detail.harga_jual_3 * penjualan_detail.jumlah) as totalrata'))
                            ->first();
				...
				if ($penjualan != null) {
                    ...
                    $totpenjualanrata = $penjualan->totalrata;
                }
				($pembelian != null) ? $totpembelian = $pembelian->total : $totpembelian = 0;

				$totpendapatan = $totpenjualan + $totpenjualanrata;
		            ...
		            $pdf = App::make('dompdf.wrapper');
		            	...
		            	$pdf->loadView('laporan.transaksi.laba.print', 
			                [
                                ...
                                'penjualanrata' => $totpenjualanrata,
    ...
    public function getRekapLaba(Request $request) {
        ...
        if ($penjualan !== null) {
            ...
            $data['penjualanrata'] = $penjualan->totalrata;
        }
