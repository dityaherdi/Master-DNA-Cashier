...
function reloadRekap() {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            var penjualanrata = 0;
            if (res.penjualanrata != null && jQuery.trim(res.penjualanrata) != '') {
                penjualanrata = intVal(res.penjualanrata)
            }
