...
<div class="row">
    ...
    <div class="col-sm-4 form-horizontal">
        <div class="form-group">
            <label for="penambahan_1" class="control-label col-sm-4">Rp. 1 : </label>
            <div class="col-sm-8">
...
<div class="row">
    ...
    <div class="col-sm-4 form-horizontal">
        <div class="form-group">
            <label for="penambahan_2" class="control-label col-sm-4">Rp. 2 : </label>
            <div class="col-sm-8">
...
<div class="row">
    <div class="col-sm-4 form-horizontal">
        <div class="form-group">
            <label for="markup_3" class="control-label col-sm-6">Markup 3 (%) : </label>
            <div class="col-sm-6">
    ...
    <div class="col-sm-4 form-horizontal">
        <div class="form-group">
            <label for="penambahan_3" class="control-label col-sm-4">Rp. 3 : </label>
            <div class="col-sm-8">
    ...
    <div class="col-sm-4 form-horizontal">
        <div class="form-group">
            <label for="harga_jual_3" class="control-label col-sm-4">Harga 3 : </label>
            <div class="col-sm-8">
