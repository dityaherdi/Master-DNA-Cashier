...
<table id="dataTableBuilder" class="table table-striped table-bordered table-hover display select tg"
    ...
    @foreach($penjualan as $i => $value)
        ...
        <tr>
            ...
            <th style="text-align: center;" class="tg-3wr7-detail"><strong>Rata-Rata</strong></th>
        </tr>
        ...
        @foreach($value->penjualandetail as $detail)
            <tr>
                ...
                <td style="text-align: right;" class="tg-rv4w-detail">{{ number_format(($detail->harga_jual_3 * $detail->jumlah) - ($detail->harga_beli * $detail->jumlah), 0, ',', '.') }}</td>
